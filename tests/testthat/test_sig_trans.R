...
data <- eegble(signal = dplyr::tibble(.id= rep(c(1L,2L), each = 10), sample= rep(seq(-4L,5L), times = 2), X = sin(1:20), Y = cos(1:20)),
...
data_NA <- eegble(signal = dplyr::tibble(.id= rep(c(1L,2L), each = 10), sample= rep(seq(-4L,5L), times = 2), X = sin(1:20), Y = cos(1:20)),
           events = dplyr::tribble(~.id, ~type,        ~description, ~sample, ~size, ~channel,
...
data_XY <- eegble(signal = dplyr::tibble(.id= rep(c(1L,2L), each = 10), sample= rep(seq(-4L,5L), times = 2), X = sin(1:20), Y = cos(1:20)),
           events = dplyr::tribble(~.id, ~type,        ~description, ~sample, ~size, ~channel,
                                      1L, "New Segment",  NA_character_,          -4L,       1L,   NA,
...
data0 <- eegble(signal = dplyr::tibble(.id= rep(c(1L,1L), each = 10), sample= seq(1L,20L), X = sin(1:20), Y = cos(1:20)),
           events = dplyr::tribble(~.id, ~type,        ~description, ~sample, ~size, ~channel,
...
data1 <- eegble(signal = dplyr::tibble(.id= rep(c(1L,2L), each = 10), sample= rep(seq(-4L,5L), times = 2), X = sin(1:20), Y = cos(1:20)),
           events = dplyr::tribble(~.id, ~type,        ~description, ~sample, ~size, ~channel,
