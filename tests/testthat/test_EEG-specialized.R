...
test_that("can segment using lim", {
  ...
  expect_equal(all(d00$events$.initial + d00$events$.size - 1 <= max(d00$signal$.sample_id)), TRUE)
  expect_equal(all(s1$events$.initial + s1$events$.size - 1 <= max(s1$signal$.sample_id)), TRUE)
  expect_equal(all(s1_u$events$.initial + s1_u$events$.size - 1 <= max(s1_u$signal$.sample_id)), TRUE)
  expect_equal(all(s1_u2$events$.initial + s1_u2$events$.size - 1 <= max(s1_u2$signal$.sample_id)), TRUE)
  expect_equal(all(s1_u2$events$.initial + s1_u2$events$.size - 1 <= max(s1_u2$signal$.sample_id)), TRUE)
})
...
test_that("times remain similar; sample0 = -100", {
    ...
    expect_equal(as.numeric(events_tbl(data_d)$.initial/250 ), as.numeric(events_tbl(data_eeg)$.sample_0/500)  , tolerance = 1/500 + .00001)
...
data_eegm1$events$.initial <- data_eegm1$events$.sample_0 +1
...
test_that("times remain similar; sample0 = 0", {
    ...
    expect_equal(as.numeric(events_tbl(data_dm1)$.initial/250 ), as.numeric(events_tbl(data_eegm1)$.sample_0/500 ), tolerance = 1/500 + .00001)
})
...
data_eeg0$events$.initial <- data_eeg0$events$.sample_0 +100
...
test_that("times remain similar; sample0 = 0", {
    ...
    expect_equal(as.numeric(events_tbl(data_d0)$.initial/250 ), as.numeric(events_tbl(data_eeg0)$.sample_0/500 ), tolerance = 1/500 + .00001)
})


data_eeg1 <- data_eeg
data_eeg1$signal$.sample_id <- data_eeg1$signal$.sample_id +101
data_eeg1$events$.initial <- data_eeg1$events$.sample_0 +101
...
test_that("times remain similar; sample0 = 1", {
    ...
    expect_equal(as.numeric(events_tbl(data_d1)$.initial/250 ), as.numeric(events_tbl(data_eeg1)$.sample_0/500 ), tolerance = 1/500 + .00001)
})

data_eeg2 <- data_eeg
data_eeg2$signal$.sample_id <- data_eeg2$signal$.sample_id +102
data_eeg2$events$.initial <- data_eeg2$events$.sample_0 +102
...
test_that("times remain similar; sample0 = 2", {
    ...
    expect_equal(as.numeric(events_tbl(data_d2)$.initial/250), as.numeric(events_tbl(data_eeg2)$.sample_0/500), tolerance = 1/500 + .00001)
})
...
data_eeg100$events$.initial <- data_eeg100$events$.sample_0 +201
...
test_that("times remain similar; sample0 = 101", {
    ...
    expect_equal(as.numeric(events_tbl(data_d100)$.initial/250 ), as.numeric(events_tbl(data_eeg100)$.sample_0/500 ), tolerance = 1/500 + .00001)
})
...
test_that("times remain similar; q=20", {
    ...
    expect_equal(as.numeric(events_tbl(data_d)$.initial/25 ), as.numeric(events_tbl(data_eeg)$.sample_0/500 ), tolerance = 1/20)
...
test_that("times remain similar; max_sample=100", {
    ...
    expect_equal(as.numeric(events_tbl(data_dmax)$.initial/100 ), as.numeric(events_tbl(data_eeg)$.sample_0/500 ), tolerance = 1/20)
