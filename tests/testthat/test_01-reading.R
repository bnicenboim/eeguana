...
test_that("write vhdr",{
  ...
  expect_true(file.exists("X_home_bruno_R_x86_64_pc_linux_gnu_library_4_1_eeguana_testdata_asalab_export_bv_vhdr.vhdr"))
  file.remove("X_home_bruno_R_x86_64_pc_linux_gnu_library_4_1_eeguana_testdata_asalab_export_bv_vhdr.vhdr")
  file.remove("X_home_bruno_R_x86_64_pc_linux_gnu_library_4_1_eeguana_testdata_asalab_export_bv_vhdr.dat")
  file.remove("X_home_bruno_R_x86_64_pc_linux_gnu_library_4_1_eeguana_testdata_asalab_export_bv_vhdr.vmrk")
