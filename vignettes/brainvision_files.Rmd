---
title: "Introducction - Manipulating a clean EEG file exported from BrainVision 2.0"
...
```{r downloading, cache = TRUE, eval = any(!file.exists("faces.dat","faces.vmrk","faces.dat"))}
