...
The key problem that **eeguana** solves is manipulating already pre-processed (i.e.,
...
of the occipital and parietal lobes using the capabilities inherited from `dplyr`, and the special function, `channelMeans`, a wrapper for `rowMeans`, which takes as arguments the `eeg_lst` object, the channels, and whether missing values should be omitted from the calculations.
