...
f <- test(sg,is_channel_dbl, mean, na.rm=TRUE)
x <- summarize_if(sg,is_channel_dbl, mean, na.rm=TRUE)
x <- summarize(sg,!!!f)
x <- summarize(sg,mean(Oz))
summarize(sg, mean(Fp1))
select.eeg_lst(sg, Fp1)
summarize_eval_signal(sg, f)
