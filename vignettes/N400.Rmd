...
The EEG dataset and the script used here is available in [](). In the experiment, participants (technicians of our lab) read sentences such as the following one:
