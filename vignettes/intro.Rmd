...
```{r downloading, eval=FALSE, cache=TRUE, include=FALSE}
...
eeguana:::plot_ica.eeg_ica_lst(faces_ica, samples = seq(s_peaks[2]-500,s_peaks[2]+1000))
```
